...
SRC_URI="http://test-oracle.oss-cn-hangzhou.aliyuncs.com/php-5.4.27.tar.gz"
PKG_NAME=`basename $SRC_URI`
PKG_NAME_DIR=php-5.4.27
DIR=`pwd`
...
#adjust php.ini
sed -i 's#; extension_dir = \"\.\/\"#extension_dir = "/alidata/php/lib/php/extensions/no-debug-non-zts-20100525/"#'  /alidata/php/etc/php.ini
...
#add ZendGuardLoader
mkdir -p /alidata/php/lib/php/extensions/no-debug-non-zts-20100525/
if [ `uname -m` == "x86_64" ];then
  ...
  mv ./ZendGuardLoader-70429-PHP-5.4-linux-glibc23-x86_64/php-5.4.x/ZendGuardLoader.so /alidata/php/lib/php/extensions/no-debug-non-zts-20100525/
else
  ...
  mv ./ZendGuardLoader-70429-PHP-5.4-linux-glibc23-i386/php-5.4.x/ZendGuardLoader.so /alidata/php/lib/php/extensions/no-debug-non-zts-20100525/
fi
echo "zend_extension=/alidata/php/lib/php/extensions/no-debug-non-zts-20100525/ZendGuardLoader.so" >> /alidata/php/etc/php.ini
