...
SRC_URI="http://zy-res.oss-cn-hangzhou.aliyuncs.com/php/php-5.6.5.tar.gz"
PKG_NAME=`basename $SRC_URI`
PKG_NAME_DIR=php-5.6.5
DIR=`pwd`
...
if [ "$(cat /proc/version | grep redhat)" != "" ];then
  ...
  yum makecache
  yum -y install libtool autoconf patch fiex* libxml2 libxml2-devel ncurses libcurl libcurl-devel ncurses-devel libtool-ltdl-devel libtool-ltdl libmcrypt libmcrypt-devel freetype-devel libpng libpng-devel libcurl-devel libcurl openssl openssl-devel libjpeg-devel libaio*
...
#note : The CentOS 5 series, Yum will install 32 bit packet, then filter out 32.
  ...
  yum makecache
  yum -y install libtool autoconf patch libxml2 libxml2-devel ncurses ncurses-devel libtool-ltdl-devel libtool-ltdl libmcrypt libmcrypt-devel freetype-devel libpng libpng-devel libjpeg-devel openssl openssl-devel libaio*
...
cp /alidata/install/php-5.6.5/modules/opcache.so  /alidata/php/lib/php/extensions/no-debug-non-zts-20121212/
