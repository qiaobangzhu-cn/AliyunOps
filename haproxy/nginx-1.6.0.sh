...
mkdir -p /alidata/www/web01
echo '<html><head><title>Welcome to web01!</title></head><body bgcolor="white" text="black"><center><h1>Welcome to web01!</h1></center></body></html>' > /alidata/www/web01/index.html
chown www:www /alidata/www/web01/index.html
cat > $VHOSTS/web01.conf << EOF
server {
    listen       81 default;
    server_name  _;
	#index.php or index.jsp ???
    index index.html index.htm;
    root /alidata/www/web01;
	####<<<PHP settings>>>####
	#location ~ .*\.(php|php5)?$
	#{
...
mkdir -p /alidata/www/web02
echo '<html><head><title>Welcome to web02!</title></head><body bgcolor="white" text="black"><center><h1>Welcome to web02!</h1></center></body></html>' > /alidata/www/web02/index.html
chown www:www /alidata/www/web02/index.html
cat > $VHOSTS/web02.conf << EOF
server {
    listen       82 default;
    server_name  _;
        #index.php or index.jsp ???
    index index.html index.htm;
    root /alidata/www/web02;
        ####<<<PHP settings>>>####
        #location ~ .*\.(php|php5)?$
        #{
        #       fastcgi_pass  127.0.0.1:9000;
