...
#  yum install -y --nogpgcheck telnet iftop htop syslog-ng eventlog libnetfilter_conntrack tmux lrzsz atop numactl libnet sendmail tcpdump sysstat mailx
   yum install -y --nogpgcheck telnet iftop htop libnetfilter_conntrack tmux lrzsz atop numactl libnet tcpdump sysstat nc
