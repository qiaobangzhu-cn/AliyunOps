...
SRC_URI="http://zy-res.oss-cn-hangzhou.aliyuncs.com/mongodb/mongodb-linux-x86_64-2.6.8.tgz"
...
rm -rf mongodb-linux-x86_64-2.6.8/
tar vxf mongodb-linux-x86_64-2.6.8.tgz 
mv mongodb-linux-x86_64-2.6.8/* /alidata/mongodb
