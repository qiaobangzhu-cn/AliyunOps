...
rm -rf apache-tomcat-7.0.53
if [ ! -f apache-tomcat-7.0.53.tar.gz ];then
  wget http://t-down.oss-cn-hangzhou.aliyuncs.com/apache-tomcat-7.0.53.tar.gz
fi
tar zxvf apache-tomcat-7.0.53.tar.gz
mv apache-tomcat-7.0.53/*  /alidata/server/tomcat7
