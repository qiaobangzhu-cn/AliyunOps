...
PHP_DIR=/alidata/server/$php55_dir
...
make install
cd ..
cp ./php-5.5.7/php.ini-production $PHP_DIR/etc/php.ini
#adjust php.ini
sed -i "s#; extension_dir = \"\.\/\"#extension_dir = "$PHP_DIR/lib/php/extensions/no-debug-non-zts-20121212/"#" $PHP_DIR/etc/php.ini
...
###zend###
mkdir -p $PHP_DIR/lib/php/extensions/no-debug-non-zts-20121212/
...
install -v -m755 ./php-5.5.7/sapi/fpm/init.d.php-fpm  /etc/init.d/php-fpm55
